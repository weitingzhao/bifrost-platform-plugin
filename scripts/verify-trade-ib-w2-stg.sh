#!/usr/bin/env bash
# TIBM Rollout W2 — runtime verify STG celery-worker after Platform IB Gateway bars rollout.
set -euo pipefail
...
echo "== [2/7] Daemon still scaled down (D10) =="
...
echo
echo "TIBM W2 STG runtime verification OK"
